    ...
    <section class="content">
	    <div class="box">
    		<div class="box-header with-border">
	        	<h3 class="box-title">Report Data Claim Agent & Retail</h3>
	        ...
	        <div class="box-body">
	        	<form action="ClaimAct.do" method="POST" name="jurnal">
		          	<div class="col-xs-2">
    	...
    	<div class="box">
    		<div class="box-header with-border">
	          <h3 class="box-title">Data Claim Agent & Retail</h3>
	          	<div class="box-tools pull-right">
					  ...
					  <tbody>
						  <c:forEach var="lph" items="${lph}" >
					  		<tr>
								...
								<td>${lph.occupation}</td>
								<td>${lph.dol}</td>
								<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.claimOs}" /></td>
								<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.claimPaid}" /></td>
