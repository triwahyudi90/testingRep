  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Populasi Acceptance</li>
      </ol>
    </section>
	...
	<div class="box">
   		<div class="box-header with-border">
        	<h3 class="box-title">Report Populasi Acceptance (Internal Audit)</h3>
        ...
        <div class="box-body">
        	<form action="populasiAcceptanceAct.do" method="POST" name="jurnal">
	          	<div class="col-xs-2">
...
<!-- 		        		<button onclick="exportToExcel('dtHorizontalVerticalExample', 'Testing Excel')" class="btn btn-success">Export Table Data To Excel File</button> -->
		...
		<div class="box">
    		<div class="box-header with-border">
	          <h3 class="box-title">Data Internal Audit Populasi Acceptance</h3>
	          	<div class="box-tools pull-right">
					  ...
					  <tbody>
						  ...
						  <c:forEach var="lph" items="${lph}" >
						  		<tr>
									...
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.premiOri}" /></td>
						  		</tr>
						  </c:forEach>
					  </tbody>
              	</table>
