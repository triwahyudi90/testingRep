...
import com.aswata.report.function.sqlFunctionAudit;
 ...
 *
 */
public class populasiAcceptanceAct extends org.apache.struts.action.Action{

	private static String SUCCESS = "success";
	private static Logger log = Logger.getLogger(populasiAcceptanceAct.class);
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			sqlFunctionAudit sql = new sqlFunctionAudit();
			String dt1 = request.getParameter("dt1");
			String dt2 = request.getParameter("dt2");
			String branch = request.getParameter("branch");
			System.out.println("dt1:" + dt1 + "dt2:" + dt2 + "branch:" + branch);
			
			lph = sql.getPopulasiAcc(dt1, dt2, branch);
			if (lph.size() > 0){
