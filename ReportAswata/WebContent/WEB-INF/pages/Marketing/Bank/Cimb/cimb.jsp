...
<head>
  ...
  <title>Data Produksi CIMB Niaga</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Bank Cimb Niaga</li>
      </ol>
    </section>
    ...
    <section class="content">
	    <div class="box">
    		<div class="box-header with-border">
	        	<h3 class="box-title">Report Data Produksi CIMB Niaga</h3>
	        ...
	        <div class="box-body">
	        	<form action="cimbNiagaAct.do" method="POST" name="jurnal">
		          	<div class="col-xs-2">
    	...
    	<div class="box">
    		<div class="box-header with-border">
	          <h3 class="box-title">Data Produksi CIMB Niaga</h3>
	          	<div class="box-tools pull-right">
					  ...
					  <tbody>
						  ...
						  <c:forEach var="lph" items="${lph}" >
						  		<tr>
									...
									<td>${lph.cabang}</td>
									<td>${lph.namaTertanggung}</td>
									<td>${lph.qqName}</td>
									<td>${lph.cabang}</td>
									<td>${lph.jenisPertanggungan}</td>
									<td>${lph.transactionDate}</td>
									<td>${lph.tglEfektif}</td>
									<td>${lph.tglJatuhTempo}</td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.premiGross}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.komisi}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.komisiBank}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.diskon}" /></td>
