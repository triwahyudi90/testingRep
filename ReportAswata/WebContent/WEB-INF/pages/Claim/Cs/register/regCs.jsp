					  ...
					  <tbody>
						  ...
						  <c:forEach var="lph" items="${lph}" >
						  		<tr>
									...
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.paidAmt}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.cascoAmt}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.tplAmt}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.deductible}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.shareAswataAmt}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.shareAswata}" /></td>
									<td>${lph.noteNo}</td>
									<td>${lph.status}</td>
									<c:choose>
										<c:when test="${lph.type == 'Partial'}">
											<td><span class="label label-danger">${lph.type}</span></td>
										</c:when>
										<c:when test="${lph.type == 'ATL'}">
											<td><span class="label label-success">${lph.type}</span></td>
										</c:when>
										<c:when test="${lph.type == 'CTL'}">
											<td><span class="label label-warning">${lph.type}</span></td>
										</c:when>
									</c:choose>
						  		</tr>
						  </c:forEach>
