 ...
 *
 */
public class bankBumnAct extends org.apache.struts.action.Action{

	private static String SUCCESS = "success";
	private static Logger log = Logger.getLogger(bankBumnAct.class);
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			lph = sql.getBankBumn(dt1, dt2, bank);
			if (lph.size() > 0){
