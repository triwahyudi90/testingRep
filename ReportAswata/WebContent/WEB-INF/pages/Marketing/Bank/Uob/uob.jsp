...
<head>
  ...
  <title>Data Produksi Bank UOB</title>
    ...
    <section class="content">
	    <div class="box">
    		<div class="box-header with-border">
	        	<h3 class="box-title">Report Data Produksi Bank UOB</h3>
	        ...
	        <div class="box-body">
	        	<form action="uobAct.do" method="POST" name="jurnal">
		          	<div class="col-xs-2">
		    		...
		    		<div class="col-xs-3">
		    			<select name = "status" class="form-control select2" style="width: 100%;">
		    				<option selected="selected" value = "1">ALL</option>
		                  	...
		                  	<option value = "3">LEBIH DARI 1 TAHUN</option>
		                </select>
		    		</div>
		    		<br><br>
					<div class="col-xs-5">
    	...
    	<div class="box">
    		<div class="box-header with-border">
	          <h3 class="box-title">Data Produksi Bank UOB</h3>
	          	<div class="box-tools pull-right">
	        	...
	        	<table id="example2" class="table table-bordered table-hover" width="100%">
					<thead>
						  <tr>
			                  ...
			                  <th>TSI</th>
			                  <th>OUTSTANDING</th>
			                  <th>STATUS OUTSTANDING</th>
			                  <th>OOCUPATION ID</th>
			                  <th>RESIKO</th>
			                  <th>STATUS PERTANGGUNGAN</th>
						  </tr>
					  </thead>
					  <tbody>
						  ...
						  <c:forEach var="lph" items="${lph}" >
						  		<tr>
									...
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.premiAdj}" /></td>
									...
									<c:choose>
										<c:when test="${lph.statusOs == 'OUTSTANDING'}">
											<td><span class="label label-danger">${lph.statusOs}</span></td>
										</c:when>
										<c:when test="${lph.statusOs == 'PAID'}">
											<td><span class="label label-success">${lph.statusOs}</span></td>
										</c:when>
									</c:choose>
									<td>${lph.occupationId}</td>
									<td>${lph.jenisResiko}</td>
									<c:choose>
										<c:when test="${lph.pertanggungan == 'KURANG DARI 1 TAHUN'}">
											<td><span class="label label-warning">${lph.pertanggungan}</span></td>
										</c:when>
										<c:when test="${lph.pertanggungan == 'LEBIH DARI 1 TAHUN'}">
											<td><span class="label label-info">${lph.pertanggungan}</span></td>
										</c:when>
									</c:choose>
						  		</tr>
						  </c:forEach>
