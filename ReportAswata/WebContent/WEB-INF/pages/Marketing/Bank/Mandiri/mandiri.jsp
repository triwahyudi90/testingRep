    ...
    <section class="content">
	    <div class="box">
    		<div class="box-header with-border">
	        	<h3 class="box-title">Report Data Produksi Bank Mandiri</h3>
	        ...
	        <div class="box-body">
	        	<form action="mandiriAct.do" method="POST" name="jurnal">
		          	<div class="col-xs-2">
    	...
    	<div class="box">
    		<div class="box-header with-border">
	          <h3 class="box-title">Data Produksi Bank Mandiri</h3>
	          	<div class="box-tools pull-right">
