 ...
 *
 */
public class maybankAct extends org.apache.struts.action.Action{

	private static String SUCCESS = "success";
	private static Logger log = Logger.getLogger(maybankAct.class);
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			List lphCetak = new ArrayList(); 
			sqlFunctionMarketing sql = new sqlFunctionMarketing();
			String dt1 = request.getParameter("dt1");
			String dt2 = request.getParameter("dt2");
			String btn = request.getParameter("btndwnld");
			
			lph = sql.getMaybank(dt1, dt2);
			if (lph.size() > 0){
