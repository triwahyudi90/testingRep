...
public class DashBoardPremi {
	...
	/**
	 * @param premi the premi to set
	 */
	public void setPremi(BigDecimal premi) {
		this.premi = premi;
	}
	/**
	 * @return the prmAdjust
	 */
	public BigDecimal getPrmAdjust() {
		return prmAdjust;
	}
	/**
	 * @param prmAdjust the prmAdjust to set
	 */
	public void setPrmAdjust(BigDecimal prmAdjust) {
		this.prmAdjust = prmAdjust;
	}
	/**
	 * @return the stmp
	 */
