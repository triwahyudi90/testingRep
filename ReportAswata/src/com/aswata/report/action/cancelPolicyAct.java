 ...
 *
 */
public class cancelPolicyAct extends org.apache.struts.action.Action{

	private static String SUCCESS = "success";
	private static Logger log = Logger.getLogger(cancelPolicyAct.class);
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			lph = sql.getCancelPolicy(dt1, dt2, branch);
			if (lph.size() > 0){
