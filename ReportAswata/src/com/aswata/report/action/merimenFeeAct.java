 ...
 *
 */
public class merimenFeeAct extends org.apache.struts.action.Action{

	private static String SUCCESS = "success";
	private static Logger log = Logger.getLogger(merimenFeeAct.class);
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			lph = sql.getMerimenFee(dt1, dt2, branch);
			if (lph.size() > 0){
