...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Internal Audit
        <small>Populasi Acceptance</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Internal Audit</a></li>
	...
	<div class="box">
   		<div class="box-header with-border">
        	<h3 class="box-title">Report Policy Cancel (Internal Audit)</h3>
        ...
        <div class="box-body">
        	<form action="cancelPolicyAct.do" method="POST" name="jurnal">
	          	<div class="col-xs-2">
		...
		<div class="box">
    		<div class="box-header with-border">
	          <h3 class="box-title">Data Internal Audit Cancel Policy</h3>
	          	<div class="box-tools pull-right">
	        	...
	        	<table id="example2" class="table table-shopping" cellspacing="0" width="100%">
					<thead>
						  <tr>
							  ...
							  <th>EXPIRED DATE</th>
							  <th>EFFECTIVE ENDORSE DATE</th>
<!-- 							  <th>ENDORSE CREATED DATE</th> -->
							  <th>CURRENCY</th>
							  <th>SHARE</th>
							  <th>TSI</th>
							  <th>AMOUNT ORI</th>
					  ...
					  <tbody>
						  ...
						  <c:forEach var="lph" items="${lph}" >
						  		<tr>
									...
									<td>${lph.expiredDate}</td>
									<td>${lph.effectiveEndorseDate}</td>
<%-- 									<td>${lph.EndorseCreatedDate}</td> --%>
									<td>${lph.ccy}</td>
									<td>${lph.share}</td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.tsi}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.amtOri}" /></td>
									<td><fmt:formatNumber type="number" maxFractionDigits="2" value="${lph.amtBase}" /></td>
						  		</tr>
						  </c:forEach>
					  </tbody>
              	</table>
