...
<head>
  ...
  <title>Data Produksi Bank BNI</title>
    ...
    <section class="content">
	    <div class="box">
    		<div class="box-header with-border">
	        	<h3 class="box-title">Report Data Produksi Bank BNI</h3>
	        ...
	        <div class="box-body">
	        	<form action="bniAct.do" method="POST" name="jurnal">
		          	<div class="col-xs-2">
    	...
    	<div class="box">
    		<div class="box-header with-border">
	          <h3 class="box-title">Data Produksi BNI</h3>
	          	<div class="box-tools pull-right">
