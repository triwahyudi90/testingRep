 ...
 *
 */
public class uobAct extends org.apache.struts.action.Action{

	private static String SUCCESS = "success";
	private static Logger log = Logger.getLogger(uobAct.class);
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			System.out.println("dt1:" + dt1 + "dt2:" + dt2 + "status:" + status);
			
			lph = sql.getUob(dt1, dt2, status);
			if (lph.size() > 0){
