...
public class bankBumn {
	...
	private String polisCreatedDate;
	...
	public void setBankerClause(String bankerClause) {
		this.bankerClause = bankerClause;
	}
	public String getPolisCreatedDate() {
		return polisCreatedDate;
	}
	public void setPolisCreatedDate(String polisCreatedDate) {
		this.polisCreatedDate = polisCreatedDate;
	}
	/**
	 * @return the policyNo
	 */
